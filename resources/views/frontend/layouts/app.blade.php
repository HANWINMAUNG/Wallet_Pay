    ...
    <div id="app">
        <div class="header-meun">
            <div class="d-flex justify-content-center">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-1 text-center my-2 pt-2">
                            @if(!request()->is('/'))
