...
<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Wallet Amount Create</strong></h1>
						...
						<div class="card">
							<div class="card-body">
									<div class = "p-2">
										...
										<form action="{{ route('add-amount.store') }}" method="post" id="create">
                                            @csrf
...
@endsection
@push('script')
{!! JsValidator::formRequest('App\Http\Requests\WalletStoreRequest' , '#create') !!}
