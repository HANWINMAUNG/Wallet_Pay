...
class AdminUserController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AdminUserRequest $request,AdminUser $admn_user)
    {
        dd('here');
